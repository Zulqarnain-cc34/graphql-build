...
export type SubscriptionOnlineUsersArgs = {
...
export type OnlineUsersSubscriptionVariables = Exact<{
    status: Scalars["String"];
}>;

export type OnlineUsersSubscription = { __typename?: "Subscription" } & {
    onlineUsers: Array<
        { __typename?: "UserResponse" } & {
            ...
            >;
            success?: Maybe<
                Array<{ __typename?: "Success" } & RegularSuccessFragment>
            >;
        }
    >;
};
...
export type PostAddedSubscription = { __typename?: "Subscription" } & {
    Postadded: { __typename?: "PostResponse" } & {
        post?: Maybe<{ __typename?: "Post" } & RegularPostsFragment>;
        errors?: Maybe<
            Array<{ __typename?: "FieldError" } & RegularErrorFragment>
        >;
    };
...
export type RegularPostFragment = { __typename?: "Post" } & Pick<
    Post,
    "id" | "createdAt" | "updatedAt" | "creatorid" | "message"
>;

export type RegularPostsFragment = { __typename?: "Post" } & Pick<
    Post,
    "id" | "createdAt" | "updatedAt" | "creatorid" | "message"
> & { creator: { __typename?: "User" } & RegularUserFragment };

export type RegularRoomsFragment = { __typename?: "Rooms" } & Pick<
    Rooms,
    "id" | "adminId" | "Roomname" | "members"
>;

export type RegularSuccessFragment = { __typename?: "Success" } & Pick<
    Success,
    "field" | "message"
>;
...
export type CreateRoomMutation = { __typename?: "Mutation" } & {
    createRoom: { __typename?: "RoomResponse" } & {
        rooms?: Maybe<{ __typename?: "Rooms" } & RegularRoomsFragment>;
        errors?: Maybe<
            Array<{ __typename?: "FieldError" } & RegularErrorFragment>
        >;
        success?: Maybe<
...
export type JoinroomMutation = { __typename?: "Mutation" } & {
    joinRoom: { __typename?: "boolResponse" } & Pick<
        BoolResponse,
        "updated"
    > & {
            errors?: Maybe<
...
export type UploadImageMutation = { __typename?: "Mutation" } & {
    profilePic: { __typename?: "boolResponse" } & Pick<
        BoolResponse,
        "updated"
    > & {
            errors?: Maybe<
...
export type GetpostsQuery = { __typename?: "Query" } & {
    posts: { __typename?: "PostsResponse" } & {
        posts?: Maybe<Array<{ __typename?: "Post" } & RegularPostsFragment>>;
        errors?: Maybe<
            Array<{ __typename?: "FieldError" } & RegularErrorFragment>
        >;
        success?: Maybe<
...
export type GetroomsQuery = { __typename?: "Query" } & {
    getRoom: { __typename?: "MembersResponse" } & {
        rooms?: Maybe<
            Array<
                { __typename?: "Members" } & {
                    room?: Maybe<
                        { __typename?: "Rooms" } & RegularRoomsFragment
                    >;
                }
            >
        >;
...
export function useOnlineUsersSubscription<TData = OnlineUsersSubscription>(
    options: Omit<
        Urql.UseSubscriptionArgs<OnlineUsersSubscriptionVariables>,
        "query"
    > = {},
    handler?: Urql.SubscriptionHandler<OnlineUsersSubscription, TData>
) {
    return Urql.useSubscription<
        OnlineUsersSubscription,
        TData,
        OnlineUsersSubscriptionVariables
    >({ query: OnlineUsersDocument, ...options }, handler);
}
...
export function usePostAddedSubscription<TData = PostAddedSubscription>(
    options: Omit<
        Urql.UseSubscriptionArgs<PostAddedSubscriptionVariables>,
        "query"
    > = {},
    handler?: Urql.SubscriptionHandler<PostAddedSubscription, TData>
) {
    return Urql.useSubscription<
        PostAddedSubscription,
        TData,
        PostAddedSubscriptionVariables
    >({ query: PostAddedDocument, ...options }, handler);
}
...
export function useGetroomsQuery(
    ...
    return Urql.useQuery<GetroomsQuery>({
